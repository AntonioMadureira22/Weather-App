...
$(document).ready(function () {
  var apiUrl = "https://openweathermap.org/api/hourly-forecast";
  defaultCity(apiUrl);
});
...
$(".search-btn").click(function (event) {
  ...
  if (userInput === "") {
    ...
    var apiUrl = "pro.openweathermap.org/data/2.5/forecast/hourly?id={city ID}&appid=" + userInput + "93581f35c2cb6b03c064536e275ff676";
  }
...
var getUrl = function (cityName) {
  if (cityName === "") {
    ...
    var apiUrl =
      "pro.openweathermap.org/data/2.5/forecast/hourly?id={city ID}&appid=" + cityName + "93581f35c2cb6b03c064536e275ff676";
  }
